...
w3.eth.default_account = ACCOUNT.address  # ← .address как строка!

print(f"✅ Wallet: {ACCOUNT.address}")  # DEBUG
print(f"✅ Web3 connected: {w3.is_connected()}")

# ПРОВЕРЬ .env НА RENDER:
# PRIVATE_KEY=0xТВОЯ_СЕПОЛИЯ_ПРИВАТКА
# INFURA_SEPOLIA_URL=https://sepolia.infura.io/v3/ТВОЙ_КЛЮЧ
